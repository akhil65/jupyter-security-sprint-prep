...
class DynamicAnalysisModule:
    ...
    def run_dast_probe(self):
        ...
        try:
            ...
            if res.status_code == 200:
                self.findings.append(Finding(
                    tool="jupyter-dast-probe", category="DAST", repo=self.target_repo, issue_id="JDAST-1",
        ...
        try:
            ...
            if missing_headers:
                self.findings.append(Finding(
                    tool="jupyter-dast-probe", category="DAST", repo=self.target_repo, issue_id="JDAST-2",
